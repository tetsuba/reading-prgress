    ...
    return (
        <>
            ...
            <div
                ...
                className="min-h-96 inline-flex w-full flex-wrap items-center justify-center rounded-b-lg border-4 border-t-0 border-dashed border-gray-200 p-2 shadow-md"
            >
