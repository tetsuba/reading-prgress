                        ...
                        token
                            ? (
                                <>
                                    ...
                                    <NavLink className={getClasses} to="reading">Reading</NavLink>
                                    <NavLink className={getClasses} to="books">Books</NavLink>
                                </>
                            )
                            : (
                                <>
                                    <NavLink className={getClasses} to="/">Home</NavLink>
                                    <NavLink className={getClasses} to="contact">Contact</NavLink>
                                    <NavLink className={getClasses} to="register">Register</NavLink>
                                </>
                            )
                    }
                </div>
